...
const toggleVideoLike = asyncHandler(async (req, res) => {
    ...
    .status(201)
    .json(
        new ApiResponse(200, likedVideo, "Like Added Successfully")
    )
})
...
const toggleCommentLike = asyncHandler(async (req, res) => {
    ...
    .status(201)
    .json(
        new ApiResponse(200, likedComment, "Comment like Added Successfully")
    )
})
...
const toggleTweetLike = asyncHandler(async (req, res) => {
    ...
    .status(201)
    .json(
        new ApiResponse(200, likedTweet, "Tweet like Added Successfully")
    )
}
)
